...
def checklist(case_id):
    ...
    return render_template('client/checklist.html', case=case, documents=documents)
...
def upload_document(document_id):
    ...
    case = Case.query.filter_by(id=document.case_id, client_id=current_user.id).first_or_404()
